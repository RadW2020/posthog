...
class SharingViewerPageViewSet(mixins.RetrieveModelMixin, viewsets.GenericViewSet):
    ...
    def retrieve(self, request: Request, *args: Any, **kwargs: Any) -> Any:
        ...
        if resource.insight and not resource.insight.deleted:
            ...
            from products.user_interviews.backend.api import _merge_agent_context, _parse_identifier
            ...
            exported_data.update(
                {
                    ...
                    "interview": {
                        ...
                        "questions": topic.questions or [],
                    },
                    "vapiPublicKey": django_settings.VAPI_PUBLIC_KEY,
                    "vapiAssistantId": django_settings.VAPI_ASSISTANT_ID,
                }
            )
