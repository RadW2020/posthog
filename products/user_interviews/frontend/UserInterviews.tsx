    ...
    return (
        <SceneContent>
            <SceneTitleSection
                ...
                description="Run AI-powered voice research campaigns. Target a cohort, set a topic, and Vapi handles the interviews."
                resourceType={{
                    type: sceneConfigurations[Scene.UserInterviews].iconType || 'default_icon_type',
                }}
                actions={
                    <LemonButton type="primary" icon={<IconPlus />} data-attr="new-topic">
                        New topic
                    </LemonButton>
                }
            />
