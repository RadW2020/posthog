    ...
    async def run(self, inputs: ApplyLensInputs) -> None:
        ...
        try:
            ...
            try:
                ...
                # Re-raise the original failure even if mark_failed itself errored, so the observation
                # row left in RUNNING is at least tied to a workflow that visibly failed.
                raise
